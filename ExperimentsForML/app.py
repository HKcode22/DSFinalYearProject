...
try:
    ...
    from MLPredictiveAnalysis.funding_stage_prediction import AnomalyDetector#, apply_post_prediction_rules # <<< Rule function import commented out
except ImportError as e:
    logger.error(f"Failed to import AnomalyDetector: {e}. Anomaly detection features will be disabled.") # Removed rule func from error msg
...
CALIBRATION_PLOT_GLOB = os.path.join(VIZ_DIR, "calibration_plot*.png") # Assuming default name
