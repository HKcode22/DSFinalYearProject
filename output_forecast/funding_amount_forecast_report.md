...
Generated on: 2025-04-23 02:15:49
...
- Within 20%: 9.4%
- Within 50%: 22.1%
- Within Same Order: 77.9%
- Interval Coverage 80%: 66.9%
...
- Mean residual (QRF): $13,143,889.98
- Mean absolute residual (QRF): $38,378,558.44
- Residual standard deviation (QRF): $111,525,437.18
- Calibration slope (QRF): -0.4596

- Mean residual (Ensemble): $-1,702,608.04
- Mean absolute residual (Ensemble): $74,240,781.30
- Residual standard deviation (Ensemble): $267,927,848.41
- Calibration slope (Ensemble): -0.9947
...
The 80% prediction interval coverage of 66.9% indicates how well the model's uncertainty estimates match the actual data.
...
3. **Prediction Reliability**: The model shows weak performance with R² of -0.0121 and 9.4% of predictions within 20% of actual values.
